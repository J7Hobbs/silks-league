  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        borderRadius: '8px', background: '#0d1f0b',
        ...
        <svg style={{ flex: 1, width: '100%', filter: 'drop-shadow(0 1px 4px rgba(0,0,0,0.9)) drop-shadow(0 0 3px rgba(0,0,0,0.7))' }} viewBox="0 0 874 874" xmlns="http://www.w3.org/2000/svg">
          <g transform="translate(137, 80) scale(0.68)">
            <path
              ...
              fill={silkFill} stroke={silkStroke} strokeWidth="2" vectorEffect="non-scaling-stroke"
            />
            <path
